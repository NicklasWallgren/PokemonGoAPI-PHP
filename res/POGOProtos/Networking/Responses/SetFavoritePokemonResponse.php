...
namespace POGOProtos\Networking\Responses {
  ...
  final class SetFavoritePokemonResponse extends ProtobufMessage {
    ...
    private $_unknown;
    private $result = SetFavoritePokemonResponse_Result::UNSET; // optional .POGOProtos.Networking.Responses.SetFavoritePokemonResponse.Result result = 1
    ...
    public function write($fp) {
      if ($this->result !== SetFavoritePokemonResponse_Result::UNSET) {
        fwrite($fp, "\x08", 1);
    ...
    public function clearResult() { $this->result = SetFavoritePokemonResponse_Result::UNSET; }
    public function getResult() { return $this->result;}
    public function setResult($value) { $this->result = $value; }

    public function __toString() {
      return ''
           . Protobuf::toString('result', $this->result, SetFavoritePokemonResponse_Result::UNSET);
    }
