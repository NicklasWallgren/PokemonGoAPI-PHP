...
namespace POGOProtos\Networking\Responses {
  ...
  final class UseItemReviveResponse extends ProtobufMessage {
    ...
    private $_unknown;
    private $result = UseItemReviveResponse_Result::UNSET; // optional .POGOProtos.Networking.Responses.UseItemReviveResponse.Result result = 1
    ...
    public function write($fp) {
      if ($this->result !== UseItemReviveResponse_Result::UNSET) {
        fwrite($fp, "\x08", 1);
    ...
    public function clearResult() { $this->result = UseItemReviveResponse_Result::UNSET; }
    ...
    public function __toString() {
      return ''
           . Protobuf::toString('result', $this->result, UseItemReviveResponse_Result::UNSET)
